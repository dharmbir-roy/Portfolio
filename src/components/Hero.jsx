...
function Hero() {
  ...
  // for resume/cv
  const openPDF = () => {
    const pdfUrl = '/Dharmbir_CV.pdf';
    window.open(pdfUrl, '_blank');
};

  return (

    <section className='max-w-screen-xl flex flex-col gap-14 md:flex-row md:items-center pt-16 pb-20 md:pt-28  px-6 mx-auto'
      id='hero'
    >
      <div className='flex-1 text-center md:text-left z-[1]'>
        ...
        <p className=' w-full text-sm font-light text-neutral-50 leading-5 my-6 lg:w-[30vw] md:text-sm md:leading-6 md:my-8'>
          {tagline}
        </p>
        
        <button className='primary-btn' onClick={openPDF} >View My CV</button>
        

      </div>

      <div className=' flex gap-2 justify-center md:gap-3 lg:gap-5 z-[1]'>
        <div className='w-[403px] bg-gradient-to-br from-blue-950 to-slate-900 rounded-lg border border-blue-500 p-6'>
